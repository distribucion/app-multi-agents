...
for s in multiagent.stream(
    {
        "messages": [
            HumanMessage(
                content="""Write me a report on the future of the world in 10 years with AI. After researching the future of the world in 10 years with AI, pass the results to the blog manager to generate the final blog post. Once done, pass it to the social media manager to write a tweet on the topic. Also, create an image that visually represents the concept of the tweet on the topic."""
            )
        ],
    },
